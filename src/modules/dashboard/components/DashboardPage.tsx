...
import { BranchSalesCard } from './BranchSalesCard';
...
export function DashboardPage() {
  ...
  const { kpis, branchSalesCards } = data;
  ...
  return (
    <ScrollArea className="h-[calc(100vh-4rem)]">
      <div className="p-6 space-y-6 pb-10">
        ...
        {/* Branch Sales Cards Section */}
        <AnimatePresence mode="wait">
          {branchSalesCards && branchSalesCards.length > 0 && (
            <motion.section
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h2 className="text-xl font-bold">مبيعات الفروع</h2>
                    <p className="text-sm text-muted-foreground">الورديات المفتوحة فقط</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {branchSalesCards.map((branch, index) => (
                  <BranchSalesCard 
                    key={branch.id} 
                    branch={branch} 
                    currency={currency}
                ...
                <ScrollArea className="h-[350px]">
                  <div className="space-y-3">
                    {data.topProducts.map((product, index) => (
                      <motion.div 
                        key={product.id} 
                        className="flex items-center gap-4 p-3 rounded-2xl bg-gradient-to-l from-muted/30 to-transparent hover:from-muted/50 transition-all duration-300 cursor-pointer"
                        variants={itemVariants}
                        whileHover={{ x: -3 }}
                      >
                        <div className={cn(
                  ...
                  <div className="space-y-3">
                    {data.branchPerformance.map((branch, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-bold">{formatCurrency(branch.sales, currency)}</span>
              ...
              <ScrollArea className="h-[300px]">
                <div className="space-y-3">
                  {data.recentInvoices.map((invoice, index) => (
                    <motion.div 
                      key={invoice.id} 
                      className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-l from-muted/30 to-transparent hover:from-muted/50 transition-all duration-300 cursor-pointer group"
                      variants={itemVariants}
                      whileHover={{ x: -5 }}
                    >
                      <div className="flex items-center gap-3">
